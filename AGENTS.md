...
| 3 | audio callback and AudioWorklet ring | ✅ WASAPI device + mixer | ✅ Linux/PulseAudio · ✅ Web/AudioWorklet · ⬛ three |
...
| AudioWorklet running the *same* mixer as the native devices | `tools/web/audio-worklet.mjs`, `src/audio/` |
